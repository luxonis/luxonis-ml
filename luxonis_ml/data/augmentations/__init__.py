...
Engines may expose `AugmentationEngine.applied_augmentations` to report configured paths and
runtime parameters used by their latest call. The base implementation returns
an empty dictionary.
"""
