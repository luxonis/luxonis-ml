...
class YoloV6OBBParser(BaseParser):
    """Parses annotations from YoloV6 OBB (oriented bounding box) annotations to LDF.
    ...
    def validate(dataset_dir: Path) -> bool:
        for split in ["train", "valid", "test"]:
            ...
            if YoloV6OBBParser.validate_split(img_split) is None:
                return False
        return True
    ...
    def from_split(
        ...
        """Parses annotations from YoloV6 OBB (oriented bounding box) format to LDF.
