> [!IMPORTANT]
> This README is deprecated. Use the GitHub Pages documentation instead: https://luxonis.github.io/luxonis-ml/latest/luxonis_ml.data.html
...
- `CutMix` - CutMix augmentation. Replaces a random rectangular region of one image with the corresponding region from another image.
