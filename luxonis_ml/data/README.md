...
For hands-on examples of how to prepare data with LuxonisML, check out [this guide](https://github.com/luxonis/depthai-ml-training/tree/main/training#%EF%B8%8F-prepare-data-using-luxonis-ml).
