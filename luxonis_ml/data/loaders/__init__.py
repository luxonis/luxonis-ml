...
Both are read by `luxonis_ml.vizlab.adapters.arrays.array_payload`, which
prefers the named form when the annotations occupy distinct class slots. Prefer
the per-channel form for anything whose channels have meanings worth recording
