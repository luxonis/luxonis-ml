...
class TrackedAugmentations(dict[str, Params]):
    ...
    The subclass keeps loader-generated provenance distinguishable from a
    dataset record's arbitrary ``"augmentations"`` metadata while preserving
    the public mapping shape and JSON serialization behavior.
    """
