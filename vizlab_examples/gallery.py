...
Renders a set of ONGs into ``vizlab_examples/output/``, each a self-contained
figure grouping related features so it can drop straight into the docs:
...
It synthesizes its own backdrops with numpy, so it needs no external assets.
