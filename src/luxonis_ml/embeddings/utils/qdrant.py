...
class QdrantManager:
    ...
    def start_docker_qdrant(self):
        ...
        if not self.does_container_exist():
            ...
            volume_path = os.path.expanduser("~/.cache/"+self.container_name+"/data")
...
class QdrantAPI:
    ...
    def __init__(self, host="localhost", port=6333, collection_name=DEFAULT_COLLECTION_NAME):
    ...
    def get_payloads_from_ids(self, ids):
        ...
        hits = self.client.retrieve(collection_name=self.collection_name, 
                                ids=ids, 
                                with_payload=True, 
                                with_vectors=False)
    ...
    def get_all_ids(self):
        ...
        hits, _offset = self.client.scroll(collection_name=self.collection_name, 
